    ...
    <div>
        <div class="p-6 lg:p-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 gap-3 bg-white dark:bg-gray-800 dark:bg-gradient-to-bl dark:from-gray-700/50 dark:via-transparent">
            <div class="relative mx-auto w-full">
                ...
                <div class="shadow p-4 rounded-lg bg-white dark:bg-gray-700">
                    <div class="flex justify-center relative rounded-lg overflow-hidden h-52">
                        <div class="transition-transform duration-500 transform ease-in-out hover:scale-110 w-full">
                            <div class="absolute inset-0 bg-black opacity-3">
                                <img src="https://images.unsplash.com/photo-1549298916-b41d501d3772?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1712&q=80" alt="">
                            </div>
                        </div>
                    ...
                    <div class="mt-4">
                        <h2 class="font-medium text-base md:text-lg text-gray-800 dark:text-gray-50 line-clamp-1" title="New York">
                            Statue of Liberty
                        </h2>
                        <p class="mt-2 text-sm text-gray-800 dark:text-gray-50 line-clamp-1" title="New York, NY 10004, United States">
                    ...
                    <div class="flex items-center">
                        ...
                        <p class="ml-2 text-gray-800 dark:text-gray-50 line-clamp-1">
                        John Doe
                        </p>
                    </div>

                    <div class="flex justify-end">
                        <p class="inline-block font-semibold text-primary whitespace-nowrap leading-tight rounded-xl text-gray-800 dark:text-gray-50">
